---
sidebar_position: 2
title: "Référence des types de ruches"
---

# Référence des types de ruches
...
| Type | Origine / région | Caractéristiques des cadres et caisses | Usage typique |
| --- | --- | --- | --- |
| **Zander** | Allemagne, Europe centrale | Cadre moyen (~420 × 220 mm) ; les caisses sont souvent menées en corps et demi | Apiculture de loisir et professionnelle dans les régions germanophones |
| **Dadant** | France / États-Unis (Charles Dadant) | Cadre de corps profond avec hausses à miel basses ; grand volume de couvain | Colonies fortes et production sérieuse de miel ; populaire en France, en Italie et aux États-Unis |
| **Deutsch Normal** (DN / DNM) | Allemagne | Cadre compact (~370 × 223 mm) ; caisses légères et faciles à soulever | Apiculture de loisir allemande traditionnelle ; très utilisée dans les associations et les formations |
...
Quelques repères pratiques pour choisir une valeur :
...
Zander, Dadant, Deutsch Normal et Langstroth sont tous des systèmes **verticaux à cadres mobiles**. Vous inspectez en soulevant les caisses et en retirant les cadres un à un. Ils diffèrent principalement par la taille des cadres et par la façon dont l'espace de couvain et de miel est organisé, ce qui influe sur le volume de la colonie et sur le poids de chaque caisse à soulever.

:::tip
Si vous achetez vos premières ruches et que vous voulez le plus large choix de matériel et de pièces d'occasion, le **Langstroth** (à l'échelle mondiale) ou votre **standard régional** (souvent Zander ou Deutsch Normal dans les zones germanophones, Dadant en France et en Italie) sont les paris les plus sûrs.
:::

### Ruches à rayons naturels

Les ruches **Warré** et **Top-bar** privilégient un style peu interventionniste, avec des rayons naturels bâtis sur des barrettes plutôt que sur des cadres filés.

- Une ruche **Warré** se développe vers le bas : vous ajoutez des caisses vides par en dessous (nadirage) pour que la colonie bâtisse du rayon frais du haut vers le bas, imitant un arbre creux.
- Une ruche **Top-bar** est horizontale : les barrettes sont posées côte à côte le long d'un corps en forme d'auge, et la colonie se gère en travaillant dans la longueur plutôt qu'en soulevant des caisses.

:::caution
Les ruches à rayons naturels peuvent compliquer certaines tâches. Le rayon est fragile sans cadre, la récolte se fait souvent par écrasement-filtrage plutôt que par extraction centrifuge, et l'inspection du couvain pour les maladies ou le varroa demande plus de soin. Elles sont gratifiantes, mais planifiez votre méthode avant de commencer.
:::
...
Pour en savoir plus sur le matériel et sur la façon dont les parties d'une ruche s'assemblent, voir [Matériel](/beekeeping/equipment) et le [Glossaire](/knowledge-base/glossary).
