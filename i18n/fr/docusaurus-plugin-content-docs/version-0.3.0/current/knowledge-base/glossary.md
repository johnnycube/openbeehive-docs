...
L'apiculture possède un vocabulaire qui lui est propre, auquel Openbeehive
ajoute quelques termes supplémentaires. Cette page rassemble les mots que vous
rencontrerez le plus souvent, aussi bien à la ruche que dans l'application, avec
des définitions courtes et pratiques.

Utilisez la fonction de recherche de votre navigateur pour aller directement à
un terme, ou parcourez simplement la liste. Lorsqu'un terme dispose de sa propre
page, nous y faisons un lien.

:::tip
Nouveau en apiculture ? Commencez par [la colonie](/beekeeping/the-colony) et
[premiers pas](/beekeeping/getting-started), puis revenez ici dès qu'un mot vous
pose problème.
:::
...
| **Propolis sauvage (brèches)** | Rayons construits dans les interstices ou entre les caisses, en dehors des cadres. |
| **Couvain operculé** | Nymphes scellées sous des opercules de cire. Les opercules de couvain d'ouvrières sont plats et mats ; ceux de couvain de mâles sont bombés. |
| **Cellule (alvéole)** | Un compartiment hexagonal du rayon. Les alvéoles particulières comprennent les cellules royales, les cellules de mâles et les cupules. |
...
| **Ruche** | La caisse et sa colonie. Dans Openbeehive, une ruche est l'unité que vous inspectez et étiquetez. Voir [ruches](/using-the-app/hives) et [types de ruches](/knowledge-base/hive-types). |
| **Lève-cadre** | Un levier métallique plat servant à décoller les caisses et les cadres collés par la propolis. |
...
| **Grille à reine** | Une grille dimensionnée pour laisser passer les ouvrières mais pas la reine, plus grande, utilisée pour empêcher le couvain de gagner les hausses à miel. |
| **Règne** | La période pendant laquelle une reine donnée est à la tête d'une colonie, de son introduction ou de son émergence jusqu'à son remplacement ou sa perte. Openbeehive en assure le suivi pour que l'historique de la colonie reste continu au fil des reines. |
| **Remérage** | Le remplacement de la reine d'une colonie, que ce soit pour améliorer le tempérament, la productivité ou simplement parce qu'elle est défaillante. |
| **Hausse** | Une caisse ajoutée au-dessus du couvain, généralement par-dessus une grille à reine, dans laquelle les abeilles stockent le miel excédentaire en vue de la récolte. |
| **Supersédure** | Le remplacement discret d'une reine défaillante par une nouvelle, élevée par la colonie, généralement sans essaimage. |
...
:::caution
Les délais d'attente relèvent de la législation et de la sécurité alimentaire, et
ils diffèrent selon les produits et les pays. Considérez l'étiquette comme la
référence et vérifiez les règles en vigueur dans votre pays.
:::
...
| Terme | Signification |
| --- | --- |
| **Événement** | Un enregistrement en ajout seul de quelque chose qui s'est produit (par exemple une récolte ou un traitement). Les événements n'entrent jamais en conflit lors de la synchronisation. Voir [historique et événements](/developers/history-and-events). |
| **HLC (horloge logique hybride)** | Le système d'horodatage qu'Openbeehive utilise pour ordonner les modifications faites sur différents appareils, même hors ligne, afin que la synchronisation reste cohérente. Voir [protocole de synchronisation](/developers/sync-protocol). |
| **Couleur de marquage** | La couleur internationale de marquage de la reine pour l'année de son introduction (blanc, jaune, rouge, vert, bleu sur un cycle de cinq ans). Voir [couleurs de marquage des reines](/knowledge-base/queen-marking-colours). |
...
sont traités dans la [section développeurs](/category/developers). Pour un usage
quotidien, il vous suffit de savoir que vos données fusionnent proprement entre
appareils sans jamais vous demander de résoudre un conflit.
:::
